...
<body>
	...
	%>
        ...
        <td><a href="tviewsachievements2.jsp?username=<%=rs1.getString("username")%>&year=<%=rs1.getString("yr")%>&branch=<%=rs1.getString("branch")%>"><button type="button">View Details</button></a></td>
        </tr>
        <%
            }
        }
        ...
        %>
         ...
         <br/><br/><a href="tviewsachievements.jsp"><button type="button">Back</button></a>
        </center> 
